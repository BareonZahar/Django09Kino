# Generated by Django 4.2.5 on 2023-09-27 16:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='kino',
            name='actor',
            field=models.ManyToManyField(to='catalog.actor', verbose_name='Актер'),
        ),
        migrations.AlterField(
            model_name='kino',
            name='genre',
        ...
        migrations.AlterField(
            model_name='status',
            name='name',
            field=models.CharField(choices=[('бесплатно', 'бесплатно'), ('базовая', 'базовая'), ('супер', 'супер')], max_length=60, verbose_name='Подписка'),
        ),
    ]
